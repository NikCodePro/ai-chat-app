...
type Props = NativeStackScreenProps<AuthStackParamList, "SignupPhonePassword">;

export function SignupPhonePasswordScreen({ navigation, route }: Props) {
  const { name, phone, signupToken } = route.params;
    ...
    <ScreenWrapper>
      <View style={styles.container}>
        ...
        <Text style={styles.subtitle}>
          Verified: {name || "User"} ({phone || "Phone"})
        </Text>
        <GradientCard>
